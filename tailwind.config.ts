  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'radial-gradient(at 40% 20%, hsl(var(--primary) / 0.1) 0px, transparent 50%), radial-gradient(at 80% 0%, hsl(25 70% 45% / 0.08) 0px, transparent 50%)',
      },
      backgroundSize: {
        'grid': '60px 60px',
        'dot': '24px 24px',
      ...
      boxShadow: {
        ...
        'medium': '0 4px 12px hsl(var(--foreground) / 0.06), 0 8px 32px hsl(var(--foreground) / 0.06)',
        'large': '0 8px 24px hsl(var(--foreground) / 0.08), 0 16px 64px hsl(var(--foreground) / 0.08)',
        'elevated': '0 12px 40px hsl(var(--foreground) / 0.1), 0 24px 80px hsl(var(--foreground) / 0.08)',
        'glow-sm': '0 0 10px hsl(var(--primary) / 0.2)',
        'glow': '0 0 20px hsl(var(--primary) / 0.25), 0 0 40px hsl(var(--primary) / 0.1)',
